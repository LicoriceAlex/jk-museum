...
export const BlocksIcon: React.FC<IconProps> = ({ size = 24, color = "#000000", strokeColor, className }) => {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color} xmlns="http://www.w3.org/2000/svg" className={className}>
      <g clipPath="url(#clip0_4418_9941)">
        {/* Каждый 'path' элемент должен использовать actualStrokeColor */}
        <path d="M17 10H19C21 10 22 9 22 7V5C22 3 21 2 19 2H17C15 2 14 3 14 5V7C14 9 15 10 17 10Z"
              stroke={actualStrokeColor} strokeWidth="1.5" strokeMiterlimit="10"
